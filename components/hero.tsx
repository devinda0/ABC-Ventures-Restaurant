...
import { ChevronDownIcon, ShoppingCartIcon, Bars3Icon, XMarkIcon } from "@heroicons/react/24/outline";
      ...
      <div className="relative z-10">
        ...
        <nav className="flex items-center justify-between px-8 py-6 lg:px-16">
          ...
          <div className="flex items-center space-x-4">
            {/* Cart */}
            <div className="flex gap-2 bg-primary px-4 py-2 rounded-tl-2xl rounded-br-2xl items-center text-white">
          ...
          <div className="bg-white rounded-tl-[16px] rounded-br-[16px] shadow-lg flex flex-col lg:flex-row items-stretch max-w-6xl w-full overflow-hidden">
            ...
            <div className="relative flex-1 min-w-[150px]">
              <select 
                ...
                className={`w-full px-6 py-4 bg-transparent border-none outline-none cursor-pointer appearance-none ${
